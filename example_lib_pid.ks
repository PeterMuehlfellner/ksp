...
print " ".
print "  Keys:".
print "     Action Group 5 : -10 hover altitude".
print "     Action Group 6 :  -1 hover altitude".
print "     Action Group 7 :  +1 hover altitude".
print "     Action Group 8 : +10 hover altitude".
...
on ag5 { set seekAlt to seekAlt -10. preserve. }.
on ag6 { set seekAlt to seekAlt - 1. preserve. }.
on ag7 { set seekAlt to seekAlt + 1. preserve. }.
on ag8 { set seekAlt to seekAlt +10. preserve. }.
